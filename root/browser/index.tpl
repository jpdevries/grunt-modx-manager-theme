...
<link rel="stylesheet" type="text/css" href="{$_config.manager_url}min/index.php?f={$_config.manager_url}templates/default/assets/css/xtheme-modx.css,{$_config.manager_url}templates/default/assets/css/index.css" />
{else}
<link rel="stylesheet" type="text/css" href="{$_config.manager_url}assets/ext3/resources/css/ext-all-notheme-min.css" />
<!--link rel="stylesheet" type="text/css" href="{$_config.manager_url}templates/default/assets/css/xtheme-modx.css" /-->
<link rel="stylesheet" type="text/css" href="{$_config.manager_url}templates/default/assets/css/index.css" />
{/if}
